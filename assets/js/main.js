(function ($) {
	...
	////////////////////////////////////////////////////
	// 31. Lipstick Color Picker Js
	// Select the lipstick bullet part (top) and the color picker input
	const lipstickBullet = document.querySelector('.ls-bullet');
	const colorPicker = document.getElementById('color-picker');
	const colorbox = document.querySelectorAll(".box")
	colorbox.forEach((e)=>{
		e.addEventListener('click',()=>{
			lipstickBullet.setAttribute('fill',e.dataset.color)
		})
		console.log(e.dataset)
	})


	// Listen for color changes in the color picker input
	colorPicker.addEventListener('input', function () {
		// Get the selected color
		const selectedColor = colorPicker.value;
		// Change the fill color of the lipstick top (bullet)
		lipstickBullet.style.fill = selectedColor;
	});
